...
class Subject {
    ...
    toggleDarkMode() {
        ...
        this.notifyObservers('darkModeChanged', this.state.darkMode);
    }
...
class MusicPlayer extends Subject {
    constructor() {
        ...
        this.state = { song: {}, playing: false, darkMode: false};
    }
...
class SidebarPlayer extends Observer {
    ...
    update(event, data) {
        ...
        if (event === 'darkModeChanged') {
            if (data) {
                this.playerElement.classList.add('dark-mode');
            } else {
                this.playerElement.classList.remove('dark-mode');
            }
        }
